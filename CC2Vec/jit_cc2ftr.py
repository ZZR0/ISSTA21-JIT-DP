...
if __name__ == '__main__':
    ...
    if params.train is True:
        ...
        data = list(zip(ids, labels, msgs, codes))
        random.shuffle(data)

        ids = [elem[0] for elem in data[:1000*params.batch_size]]
        labels = [elem[1] for elem in data[:1000*params.batch_size]]
        msgs = [elem[2] for elem in data[:1000*params.batch_size]]
        codes = [elem[3] for elem in data[:1000*params.batch_size]]
